...
void ana()
{
    const char* inputFiles[] = {
        "path_to/background_root/1/unweighted_events.root",
        "path_to/background_root/2/unweighted_events.root",
        "path_to/background_root/6/unweighted_events.root",
        "path_to/background_root/7/unweighted_events.root",
        "path_to/background_root/8/unweighted_events.root",
        "path_to/background_root/9/unweighted_events.root"
    };

    const char* outputFiles[] = {
        "output_zz_background_1",
        "output_zz_background_2",
        "output_zz_background_6",
        "output_zz_background_7",
        "output_zz_background_8",
        "output_zz_background_9"
    };
